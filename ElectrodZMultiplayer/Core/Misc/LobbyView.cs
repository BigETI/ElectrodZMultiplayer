...
namespace ElectrodZMultiplayer
{
    ...
    internal class LobbyView : ILobbyView
    {
        ...
        public LobbyView(string lobbyCode, string name, bool isPrivate, uint minimalUserCount, uint maximalUserCount, bool isStartingGameAutomatically, string gameMode, IReadOnlyDictionary<string, object> gameModeRules, uint userCount)
        {
        ...
        public static explicit operator LobbyView(LobbyData lobby)
        {
            ...
            return new LobbyView(lobby.LobbyCode, lobby.Name, lobby.IsPrivate, lobby.MinimalUserCount, lobby.MaximalUserCount, lobby.IsStartingGameAutomatically, lobby.GameMode, lobby.GameModeRules, lobby.UserCount);
        }
    }
}
